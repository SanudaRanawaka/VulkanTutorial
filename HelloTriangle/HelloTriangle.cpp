...
private:
    ...
    std::vector<vk::raii::CommandBuffer> commandBuffers; // each frame will have own commandbuffer
    // sync
    ...
    void createCommandBuffers() {
        ...
        commandBuffers = vk::raii::CommandBuffers(device, cmdBufferAllocateInfo);
    }
